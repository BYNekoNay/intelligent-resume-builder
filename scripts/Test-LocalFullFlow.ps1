...
try {
    ...
    Invoke-Api POST '/api/ai/consent' @{ policyVersion = 'v1.1.0'; providerCode = 'bailian'; taskScopes = @('JOB_MATERIAL_SELECTION', 'JOB_GENERATION'); dataCategories = @('CAREER_MATERIAL', 'JOB_DESCRIPTION', 'PERSONAL_PROFILE'); noticeHash = 'local-validation' } $token $null | Out-Null
