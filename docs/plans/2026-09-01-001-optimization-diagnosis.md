...
> ⚠ **时效性声明（2026-09-25 标注）**
>
> 本文是 2026-09-01 的**只读诊断快照**。其中标注"候选 / 待做"的条目**多数已在此后的多轮优化中闭环** ——
> 见 `docs/plans/2026-09-06-001-review.md`、`docs/plans/2026-09-01-001` 之后交付的第二轮 14 项优化，
> 以及 `docs/ideation/2026-09-04-project-optimization-ideation.md` 的「已闭环的历史问题」表（O-01~O-14）。
>
> **引用其中的"待做项"前必须按磁盘代码核实当前状态**，否则会重复修复已经完成的问题。
> 当前状态以 `PROJECT_CONTEXT.md` 与代码为准；仍未闭环的事项见 `docs/decisions/OPEN-DECISIONS.md`。
