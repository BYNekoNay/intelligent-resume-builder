...
| 移动端视口 / 可访问性 | **部分覆盖（2026-09-26 跨模块审计更正）**：`web/e2e/workflow.spec.ts:410-424` 已有 390×844 面试可用性 + 无横向溢出断言、`:456-470` 移动导航用例；剩余核心视图的移动端视口与可访问性仍未覆盖 |
